        ...
        <div class="header__main-line">
            <div class="header__container container">
                ...
                <button class="header__add-question button button--large button--icon button--icon-left js-modal-feedback">
                    <svg>
                        <use xlink:href="<?= $assetManager->getEntry('icons/sprite.svg') ?>#fcoz"></use>
                    </svg>
    ...
    <main class="page__middle main">
        ...
        <div class="page__container container <?= defined("CONTAINER_DOC") ? "container--doc" : "" ?>">
            ...
            <?php if (
                ...
                $APPLICATION->GetCurPage(false) != "/search/detail.php"  &&
                $APPLICATION->GetCurPage(false) != "/zakonodatelstvo-ob-obrazovanii/sudebnaya-praktika/baza/detail.php" &&
                $APPLICATION->GetCurPage(false) != "/regionalnaya-baza/detail.php" &&
                $APPLICATION->GetCurPage(false) != "/grazhdanam/faq/detail.php"
            ) { ?>
            <div class="section-wrapper-container">
                ...
                $md = new \Bitrix\Conversion\Internals\MobileDetect;
                ?>
                    <div id="anchor-for-mobile" class="section-wrapper-container-content <? if($md->isMobile()) { ?> mobile-version <? } ?>">
