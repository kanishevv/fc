...
<div class="search-smart-filter">
    <form id="<? echo $arParams["FILTER_NAME"] . "_form" ?>"
        ...
        <div class="search-smart-filter__row">
            ...
            <?php if ($arParams['EXACT_SEARCH_CHECKBOX'] === 'Y') { ?>
                <div class="form__field form__field--checkbox">
                    <div class="input">
                        <div class="input__wrapper input__wrapper--checkbox">
                            <input
                                class="filter__field filter__field--checkbox"
                                type="checkbox"
                                name="<?= $arParams['FILTER_NAME'] . '_searchByName' ?>"
                                <?= $request->get("{$arParams['FILTER_NAME']}_searchByName") ? 'checked' : ''; ?>
                            />
                            <span>Только по названию</span>
                        </div>
                    </div>
                </div>
            <?php } ?>
				...
				case "U"://CALENDAR
                    ...
                    <div class="search-smart-filter__row">
                        <div class="form__field form__field--small">
                            <div class="input">
                                <div class="input__wrapper">
                                    <input id="<?= $arParams["FILTER_NAME"] . "_" . $arItem["CODE"] ?>"
                                           type="text"
                                           name="<?= $arParams["FILTER_NAME"] . "_" . $arItem["CODE"] ?>"
                                           class="form__date"
                                           value="<?= $request[$arParams["FILTER_NAME"] . "_" . $arItem["CODE"]] ?>"
				                    ...
				                    <?php $APPLICATION->IncludeComponent(
					                    ...
					                    array(
						                    ...
						                    'INPUT_NAME' => $arParams["FILTER_NAME"] . "_" . $arItem["CODE"],
						                    'INPUT_VALUE' => $request[$arParams["FILTER_NAME"] . "_" . $arItem["CODE"]],
						                    'SHOW_TIME' => 'N',
						                    'HIDE_TIMEBAR' => 'Y',
					                    ),
					                    null,
