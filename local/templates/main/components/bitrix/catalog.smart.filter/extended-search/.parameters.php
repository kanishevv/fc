...
$arTemplateParameters['SEARCH_NAME'] = array(
	'PARENT' => 'DATA_SOURCE',
	'NAME' => 'Отображать поле для поиска по номеру',
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'N'
);

$arTemplateParameters["SEARCH_PLACEHOLDER"] = [
	"PARENT" => "VISUAL",
	"NAME" => "Placeholder строки поиска",
	"TYPE" => "STRING",
	"DEFAULT" => "Поиск по названию, по тексту"
]
?>