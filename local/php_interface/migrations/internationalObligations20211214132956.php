...
class internationalObligations20211214132956 extends Version
{
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Периодические доклады России',
  'ACTIVE' => 'Y',
  'SORT' => '300',
  'CODE' => 'TEXT_3',
  'DEFAULT_VALUE' => 
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Перечень проблемных тем, заключительные замечания',
  'ACTIVE' => 'Y',
  'SORT' => '400',
  'CODE' => 'TEXT_4',
  'DEFAULT_VALUE' => 
  ...
  array (
    ...
    'CODE' => 'Символьный код',
    'SORT' => 'Сортировка',
    'PROPERTY_TEXT_0' => 'Текст обязательства',
    'PROPERTY_TEXT_1' => 'Подробнее',
    'PROPERTY_TEXT_2' => 'Комментарии',
    'PROPERTY_TEXT_3' => 'Периодические доклады России',
    'PROPERTY_TEXT_4' => 'Перечень проблемных тем',
    'PROPERTY_TEXT_5' => 'Информация об исполнении',
  ),
  'Анонс|edit5' => 
  array (
